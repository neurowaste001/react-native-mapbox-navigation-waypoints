...
abstract class MapboxNavigationViewManagerSpec<T : View> : SimpleViewManager<T>() {
  ...
  abstract fun setMaxVehicleWidth(view: T?, value: Double)
  abstract fun setMaxVehicleHeight(view: T?, value: Double)
  abstract fun setMaxVehicleWeight(view: T?, value: Double)
}
